...
final class TableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func initSongList(){
        let songs = [Song(songImage: "album1", songName: "Album 1", songArtist: "Ngọt"),
                     Song(songImage: "album2", songName: "Album 2", songArtist: "Ngọt"),
                     Song(songImage: "album3", songName: "Album 3", songArtist: "Ngọt"),
                     Song(songImage: "album4", songName: "Album 4", songArtist: "Ngọt"),
                     Song(songImage: "album1", songName: "Album 1", songArtist: "Ngọt"),
                     Song(songImage: "album2", songName: "Album 2", songArtist: "Ngọt"),
                     Song(songImage: "album3", songName: "Album 3", songArtist: "Ngọt"),
                     Song(songImage: "album4", songName: "Album 4", songArtist: "Ngọt"),
                     Song(songImage: "album1", songName: "Album 1", songArtist: "Ngọt"),
